...
export class UriBuilder {
   ...
   */
  public static setBuilderOptions(options: Types.BuilderOptionsContract) : typeof UriBuilder {
   ...
   */
  public static setCredentials(userName: string, password: string, authSource?: string) : typeof UriBuilder {
   ...
   */
  public static setReplicaSet(replicaSet: Array<string | Types.HostAddress>, name?: string) : typeof UriBuilder {
    if(replicaSet) {
  ...
  private static addHost(host: string | Types.HostAddress, removeDefaultHost = true): typeof UriBuilder {
